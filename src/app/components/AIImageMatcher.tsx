...
export interface AIMatcherResult { id: string; portfolioId: string; freelancerId: string; freelancerName: string; specialization: string; rating: number; profileImage: string | null; profileGender: Gender | null; imageUrl: string; title: string; matchScore: number }
