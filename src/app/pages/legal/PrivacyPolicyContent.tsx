...
interface PrivacyPolicyContentProps {
  /** Standalone page navigates to /terms; the sign-up/settings modal just switches tabs instead. */
  onLinkToTerms: () => void;
}

export function PrivacyPolicyContent({ onLinkToTerms }: PrivacyPolicyContentProps) {
  return (
    <>
      <LegalSection title="1. What This Policy Covers">
        <p>
          ...
          <button type="button" onClick={onLinkToTerms} className="font-semibold text-gray-900 underline">Terms of Service</button>.
        </p>
      </LegalSection>
