...
interface TermsOfServiceContentProps {
  /** Standalone page navigates to /privacy; the sign-up/settings modal just switches tabs instead. */
  onLinkToPrivacy: () => void;
}

export function TermsOfServiceContent({ onLinkToPrivacy }: TermsOfServiceContentProps) {
  return (
    <>
      <LegalSection title="1. Acceptance of these Terms">
        <p>
          ...
          bound by these Terms and by our <button type="button" onClick={onLinkToPrivacy} className="font-semibold text-gray-900 underline">Privacy Policy</button>. If you do not agree, do not use the Platform.
        </p>
      </LegalSection>
