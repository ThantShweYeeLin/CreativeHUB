...
const CATEGORY_ALIASES: Array<{ label: string; aliases: string[] }> = [
  ...
  { label: 'Decorator', aliases: ['decorator', 'decorators', 'decoration', 'decor', 'florist', 'florists', 'flowers', 'floral', 'styling'] },
  { label: 'Cake/Dessert Maker', aliases: ['cake', 'cakes', 'dessert', 'desserts', 'bakery', 'baker', 'pastry'] },
  { label: 'Musician', aliases: ['dj', 'djs', 'musician', 'musicians', 'music', 'band', 'live band', 'entertainment', 'entertainer'] },
];
...
export interface FreelancerSearchable {
  ...
  minorSkills?: string[];
  /**
   * Musician only — performer format (Band, DJ, ...).
